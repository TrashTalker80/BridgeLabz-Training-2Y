...
class StudentGradeCalculator2D {
    ...
    public static void calculatePercentagesAndGrades(double[][] marks, double[] percentages, String[] grades) {
        for (int i = 0; i < marks.length; i++) {
            double total = 0.0;
    ...
    public static void displayResults(double[][] marks, double[] percentages, String[] grades) {
        System.out.println("\n=== STUDENT GRADE CALCULATION RESULTS (2D Array) ===");
    ...
    public static void main(String[] args) {
        ...
        calculatePercentagesAndGrades(marks, percentages, grades);
