...
public class CollinearPoints {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Are the points collinear (by slope)? " + areCollinearBySlope(x1, y1, x2, y2, x3, y3));
        System.out.println("Are the points collinear (by area)? " + areCollinearByArea(x1, y1, x2, y2, x3, y3));
